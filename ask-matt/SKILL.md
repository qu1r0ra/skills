...
- **`/sync`**: the end-of-task / end-of-session closeout. It reconciles one completed ticket and its Wayfinder map, runs lightweight checks, commits only reconciliation files, optionally pushes, and emits a receipt with the next frontier ticket.
